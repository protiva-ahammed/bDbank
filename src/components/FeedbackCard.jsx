    ...
    mr-0 my-5 feedback-card">
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col ml-4 text-white">
          <h4 className="font-poppins font-semiblold text-[20px] leading-[32px] text-white ">
            {name}
          </h4>
          <p className="font-poppins font-semiblold text-[15px] leading-[24px] text-dimWhite">
            {title}
          </p>
        </div>
      </div>
